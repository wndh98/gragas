...
//     useEffect(()=>{
//         if(isLogin==true){
//             setLoginButton(<li><Link to={"/logout"} className="btn btn-warning px-2">로그아웃</Link></li>);
//         }else{
//             setLoginButton(<li><Link to={"/loginForm"} className="btn btn-outline-dark me-2 px-2" >로그인</Link></li>);
//         }
...
//         <>
//             <ul className="nav col-12 col-lg-auto me-rg-auto mb-2 justify-content-center mb-md-0 align-items-center">
//                 <li><Link to={props.url} className="btn btn-outline-dark me-2 px-2" >{props.name}</Link></li>
//                 <li><Link to={props.url} className="btn btn-warning px-2">{props.name}</Link></li>
//                 <li> <Link className="px-2"><i class="bi bi-bag"></i></Link></li>
//             </ul>
//         </>
//     );
